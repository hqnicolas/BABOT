...
// The project integrates WebSockets as plain source instead of via Arduino's
// library resolver, so we normalize the ESP32 board macro here for both build paths.
